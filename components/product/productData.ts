  ...
  },
  {
    ...
    colors: [
      ...
      },
      {
        ...
        images: [
          `${productImageBase}/Heavy-Duty/Yellow%2BBlack/main Photoroom-Photoroom (2).png`,
          `${productImageBase}/Heavy-Duty/Yellow%2BBlack/IMG20250131192310-Photoroom.jpg`,
          `${productImageBase}/Heavy-Duty/Yellow%2BBlack/Zoom In Image (3).png`,
          `${productImageBase}/Heavy-Duty/Yellow%2BBlack/Complete Packaging V2 (3) copy.png`,
          `${productImageBase}/Heavy-Duty/Yellow%2BBlack/Untitled design (4).png`,
        ],
      },
      {
        id: 'black-yellow',
        ...
        images: [
          `${productImageBase}/Heavy-Duty/Black%2BYellow/main-Photoroom (1).jpg`,
          `${productImageBase}/Heavy-Duty/Black%2BYellow/IMG20250131191448-Photoroom.jpg`,
          `${productImageBase}/Heavy-Duty/Black%2BYellow/Zoom In Image (4).png`,
          `${productImageBase}/Heavy-Duty/Black%2BYellow/Complete Packaging V2 (4) copy.png`,
          `${productImageBase}/Heavy-Duty/Black%2BYellow/Untitled design.png`,
        ],
      },
    ],
  },
